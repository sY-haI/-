<template>
  <div class="front-container">
    <div style="font-size: 20px; font-weight: bold">我收藏的商品({{data.total}}件)</div>
    <el-row :gutter="20">
      <el-col :span="6" v-for="item in data.tableData" :key="item.id">
        <div @click="router.push('/front/goodsDetail?id=' + item.goodsId)" class="card"
          ...
          <img :src="item.goodsImg" alt="" style="width: 100%; height: 260px; border-radius: 5px 5px 5px 5px">
          <div style="padding: 5px">
            <div class="line1" style="font-size: 16px; margin-bottom: 10px">{{ item.goodsName }}</div>
            <div style="display: flex; align-items: center">
              <div style="color: red; flex: 1">￥<b style=" font-size: 20px">{{ item.goodsPrice }} </b></div>
