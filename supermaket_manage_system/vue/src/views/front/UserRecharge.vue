<template>
  <div class="front-container">
    <div style="font-size: 20px; font-weight: bold">我的充值记录（{{data.total}}个）</div>
    <div class="card" style="padding: 20px">
      <div style="margin-bottom: 20px; display: flex; align-items: center">
        ...
        <el-button @click="handleAdd" type="primary" style="margin-left: 20px">充值</el-button>
      </div>
      <div>
    ...
    <el-dialog title="充值页面" width="30%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding-right: 30px; padding-top: 20px">
        ...
        <el-form-item label="支付方式" prop="type" style="margin-top: 30px;">
          <el-radio-group v-model="data.form.type">
            <el-radio value="微信支付"><img style="width: 100px; height: 40px" src="@/assets/imgs/wechat_pay.png" alt=""></el-radio>
            <el-radio value="支付宝支付"><img style="width: 100px; height: 40px" src="@/assets/imgs/alipay.png" alt=""></el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
      <template #footer>
