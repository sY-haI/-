<template>
  <div class="front-container">
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.content" style="width: 300px; margin-right: 10px" placeholder="请输入商品名称查询"></el-input>
      <el-input v-model="data.goodsName" style="width: 300px; margin-right: 10px" placeholder="请输入评价内容查询"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column prop="content" label="评价内容" show-overflow-tooltip width="200"></el-table-column>
