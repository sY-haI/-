  ...
  routes: [
    { path: '/', redirect: '/login' },
    {
      ...
      children: [
        ...
        { path: 'goodsStatusAndRecommend', component: () => import('@/views/manager/GoodsStatusAndRecommend.vue')},
        { path: 'supplier', component: () => import('@/views/manager/Supplier.vue')},
        { path: 'purchaseRecord', component: () => import('@/views/manager/PurchaseRecord.vue')},
      ]
    },
    {
      path: '/front',
      ...
      children: [
        ...
        { path: 'userAddress', component: () => import('@/views/front/UserAddress.vue') },
      ]
    },
